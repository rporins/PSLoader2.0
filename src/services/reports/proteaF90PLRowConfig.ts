...
export const PROTEA_F90_PL_ROW_CONFIG: PLRow[] = [
  ...
  { type: 'measure', label: 'Net Interest', measureId: 'f90_interest', formatting: 'number', indentLevel: 1, invertSign: true },
  ...
  { type: 'measure', label: 'Tax', measureId: 'f90_tax', formatting: 'number', indentLevel: 1 },
